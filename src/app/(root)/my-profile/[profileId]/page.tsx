...
import ProfileCard from '@/custom-components/ProfileCard';
...
const ProfilePage = ({
  ...
  const user = useQuery(api.users.fetchUserById, {
  ...
  return (
    <section className="mt-9 flex flex-col">
      ...
      <div className="mt-6 flex flex-col gap-6 max-md:items-center md:flex-row">
        <ProfileCard podcastData={podcastsData!} imageUrl={user?.imageUrl!} userFirstName={user?.name!} />
      </div>
