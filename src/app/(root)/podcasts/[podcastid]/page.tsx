...
import PodcastDetailPlayer from '@/custom-components/PodcastDetailPlayer';
...
const PodcastDetails = ({ params: { podcastId } }: { params: { podcastId: Id<'podcasts'> } }) => {
  ...
  return (
    <section className="flex w-full flex-col">
      ...
      <PodcastDetailPlayer isOwner={isOwner} podcastId={podcast._id} {...podcast} podcastTitle={podcast.title} />

      <p className="text-16 pb-8 pt-[45px] font-medium text-white-2 max-md:text-center">{podcast?.description}</p>
